...
namespace MCvanderBergCalc.Mailing
{
    public partial class Mc2Agent : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            var linqagent = db.sp_InsertMc2Agent(146, 2, 1, value, "info@mcvdberg.co.za", "Tiaan (M.C.) van der Berg Inc.", "MC2Agent-123", txtEnglishSubject.Text, txtCKEditor1.Text, txtAfrikaansSubject.Text, txtCKEditor2.Text);
        }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            mcvanderbergDataContext db = new mcvanderbergDataContext();
            var linqcontents = db.spGetMC2Agentcontent(146, 1);
