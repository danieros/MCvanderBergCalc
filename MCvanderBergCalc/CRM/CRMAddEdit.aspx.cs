                ...
                if (userid > 0)
                {
                    ...
                    foreach (var linquser in linqusers)
                    {
                        ...
                        if (mySession < 2)
                        {
                            ...
                            chkPrinceton.Enabled = false;
                            chkMenlynMain.Enabled = false;
                        }
                        ...
                        chkPrinceton.Checked = Convert.ToBoolean(linquser.PricetonParkDevelopment);
                        chkMenlynMain.Checked = Convert.ToBoolean(linquser.MenlynMaine);
