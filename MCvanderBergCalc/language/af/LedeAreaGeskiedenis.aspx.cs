...
{
    public partial class LedeAreaGeskiedenis : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (var linqhistory in linqhistories)
            {
                ...
                content += "<td>" + "<a data-fancybox-type=\"iframe\" id=\"iframe1\" href=\"../en/PreviewComplimentSlip?id=" + linqhistory.UniqueID.ToString() + "\">Besigtig epos</a>" + "</td>";
                content += "</tr>";
                count++;
            }
            content += "</tbody>";
